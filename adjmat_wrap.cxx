...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__adjmat

#else
#  define SWIG_init    init_adjmat

#endif
#define SWIG_name    "_adjmat"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_adjmat(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:adjmat",&obj0,&obj1)) SWIG_fail;
  {
    npy_intp size[2] = {
      -1, -1 
    };
  ...
  adjmat(arg1,arg2,arg3,arg4,arg5,arg6);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"adjmat", _wrap_adjmat, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
